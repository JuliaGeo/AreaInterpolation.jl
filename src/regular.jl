function interpolate(::Direct, polygon, sources::AbstractVector, values::NamedTuple, source_areas, source_rtree) # should be 2 params `intensive` and `extensive` as well...
